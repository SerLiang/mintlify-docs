    ...
    <ResponseField name="items" type="ActivityItem[]">
      ...
      <Expandable title="ActivityItem fields">
        ...
        <ResponseField name="recordType" type="string">
          Internal record classification, for example `SUMMARY` or `REDEEMS`.
        </ResponseField>
        ...
        <ResponseField name="transferNetAmount" type="number">
          Net USDC amount moved. Positive means USDC left the wallet (shares received); negative means USDC entered the wallet (shares redeemed or sold).
        </ResponseField>
